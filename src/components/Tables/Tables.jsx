        ...
        <div>
            ...
            <Modal open={open}>
                <div className={styles.nav_to_modal}>
                    <p>Карточка сотрудника: {indus()[`${temp}`].name}</p>
                ...
                <div className={styles.container_text_dev}>
                    <p className={styles.text_to_dev_one}>Штатная должность: <span>{indus()[`${temp}`].dev}</span></p>
                ...
                <table className={styles.table_back_modal} cellPadding="11">
                    ...
                    <tr><td>{indus()[`${temp}`].material["1"].number_rep}</td><td>{indus()[`${temp}`].material["1"].name}</td><td>{indus()[`${temp}`].material["1"].number_mat}</td></tr>
                    <tr><td>{indus()[`${temp}`].material["2"].number_rep}</td><td>{indus()[`${temp}`].material["2"].name}</td><td>{indus()[`${temp}`].material["2"].number_mat}</td></tr>
                    <tr><td>{indus()[`${temp}`].material["3"].number_rep}</td><td>{indus()[`${temp}`].material["3"].name}</td><td>{indus()[`${temp}`].material["3"].number_mat}</td></tr>
                    <tr><td>{indus()[`${temp}`].material["4"].number_rep}</td><td>{indus()[`${temp}`].material["4"].name}</td><td>{indus()[`${temp}`].material["4"].number_mat}</td></tr>
                </table>
